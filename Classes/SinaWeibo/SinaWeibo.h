...
#import "SinaWeiboAuthViewControllerDelegate.h"
#import "SinaWeiboRequest.h"
#import "BaseAuthViewController.h"

@protocol SinaWeiboDelegate;

@interface SinaWeibo : NSObject <SinaWeiboAuthViewControllerDelegate, SinaWeiboRequestDelegate>
{
    NSString *userID;
...
@property (nonatomic, retain) BaseAuthViewController *authVC;
