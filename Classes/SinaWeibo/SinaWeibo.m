...
#pragma mark - WeiboAuthVC Delegate
- (void)weiboAuthViewController:(SinaWeiboAuthViewController *)authViewController didFailWithErrorInfo:(NSDictionary *)errorInfo
{
    [self logInDidFailWithErrorInfo:errorInfo];
}

- (void)weiboAuthViewController:(SinaWeiboAuthViewController *)authViewController didRecieveAuthorizationCode:(NSString *)code
{
    [self requestAccessTokenWithAuthorizationCode:code];
}
